    ...
    <div class="wrapper bg-white">
        <aside id="sidebar">
            ...
            <div class="main p-3">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card-title"><h5 class="mb-3">NCPR Table</h5></div>
                            <div class="table-container table-responsive mt-3">
                                <table id="ncprTable" class="table table-bordered table-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        <tr><td>1</td><td>Project A</td><td>Open</td><td>2024-03-01</td></tr>
                                        <tr><td>2</td><td>Project B</td><td>Closed</td><td>2024-02-28</td></tr>
                                        <tr><td>3</td><td>Project C</td><td>In Progress</td><td>2024-02-27</td></tr>
                                        <tr><td>4</td><td>Project D</td><td>Open</td><td>2024-02-26</td></tr>
                                    </tbody>
                                </table>
                            </div>
                        </div>
        ...
        $(document).ready(function() {
            $('#ncprTable').DataTable({
                ...
                buttons: [
                    ...
                    { extend: 'csvHtml5', text: 'Export CSV', className: 'btn btn-primary' },
